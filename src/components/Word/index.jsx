...
const Word = ({ word, transcription, translate, selectTagArr, learPercent}) => {
  ...
  return (
    <div className={styles.backgroundWord}>
      ...
      <Circle className={styles.percentCircle} percent={learPercent} strokeWidth="10" trailWidth="7" strokeColor={learPercent <= 25 ? "#bc2b2b" : learPercent <= 50 ? "#bc872b" : learPercent <= 75 ? "#bcb72b" : "#2bbc99"} />
